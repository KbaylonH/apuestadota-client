                    ...
                    <tbody>
                        ...
                        apuestas.map(apuesta=>{
                            ...
                            return <tr key={'partida_' + apuesta.id}>
                                ...
                                <Countdown date={Date.parse(apuesta.timestamp) + 1500000} intervalDelay={0} precision={3} renderer={renderer}/>
                                ...
                                <span className='green'>+ {(apuesta.monto * 1.4).toFixed(2)}</span> : 
