        ...
        <div>
            ...
            <table className='desktop-table'>
                ...
                <tbody>
                    ...
                    {!loading && resumen.length < 1 && <tr>

                        <td colSpan={3}>Sin registros</td>

                    </tr>}

                    {!loading && resumen.length > 0 && resumen.map((row, index)=>{

                        return <tr key={index}>

                            <td className='date-td'>{ row.fecha }</td>  

                            <td className={row.monto > 0 ? 'green' : 'red'}>{ row.monto > 0 ? `+ ${Number(row.monto).toFixed(2)}` : Number(row.monto).toFixed(2) }</td>
