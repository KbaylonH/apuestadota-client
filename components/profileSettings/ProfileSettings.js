...
import Account from '../accountStatus/account';
                                ...
                                <ul className='gc-profile-list'>
                                    ...
                                    <li className='gc-profile-list-item'>
                                        ...
                                        <div className='gc-list-text'>
                                            ...
                                            <p className='gc-list-text'>{user.dni_status == 0 ? 'No verificado' : ( user.dni_status == 1 ? 'Por verificar' : (user.dni_status == 2 ? 'Verificado' : 'Fallo la verificación'))} </p>
